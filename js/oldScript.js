...
/*
const existingBookTitle = document.getElementById("selectedBookTitle");
if (existingBookTitle) {
  //  existingBookTitle.remove();
  existingBookTitle.textContent = "";
} */
...
if (bookCountElement) {
    ...
    document.querySelector(".div-2").appendChild(bookCountElement);
} 
...
// Update the count display
//IMPconst bookCountElement = document.getElementById("bookCount");
let selectedTitles = [];
//IMP if (bookCountElement) {
//    bookCountElement.textContent = "Book Count: " + count + "/10";
//}
